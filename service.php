...
<head>
  <meta charset="utf-8">
  <title>Activist Investing LLC</title>
...
<header>
                ...
                <div class="col-lg-12">
                    <ul class="list-inline text-lg-right text-center">
                        <li class="list-inline-item">
                            <a href="mailto:info@companyname.com">David@activistinvestingllc.com</a>
                        </li>
                        <li class="list-inline-item">
                            <a href="callto:1234565523">Call Us:
                                <span class="ml-2"> 212-520-1819</span>
                            </a>
                        </li>
                        <li class="list-inline-item">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto">
                       ...
                       <li class="nav-item">
                        ...
                        <a  class="nav-link" href="index.html">About the Principal </a>
                      </li>
                        <li class="nav-item">

                        <a  class="nav-link" href="index.html">  Specialties
   </a>
                      </li>
                         <li class="nav-item">
   ...
   <li class="nav-item">
                            ...
                            <a class="nav-link btn btn-primary btn-sm" href="#">blog</a>
                        </li>
...
<section class="page-title overlay" style="background-image: url(images/background/wallstreet.jpg); height: 30px">
    <div class="container" style="margin-bottom: 0px">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="text-white font-weight-bold"> Specialties
</h2>
                <br><br><br><br>
...
<section style="margin:40px">
    <div class="container">
        <div class="row rounded bg-secondary">
            <!-- ceo image -->
            <div class="col-lg-5 rounded-left ceo-image" style="background-image: url(images/about/ceo.jpg);"></div>
            <div class="col-lg-7">
                <!-- ceo content -->
                <div class="p-5">
                    <h2 class="section-title section-title-border-half-white text-white">
                       Specialties </h2>
                    <p style="font-size:20px"class="text-white">Other expertise includes: capital restructuring, reverse merger aka reverse takeover, debt financing, SPAC (Special-purpose acquisition company), equity lines, capital introductions to high net worth individuals, investment bankers, and mergers and acquisitions. Additional experience includes assisting OTC listed companies with preparing for a Nasdaq Uplisting.Elaborate on each service you offer and instances where you have displayed the services.</p>
